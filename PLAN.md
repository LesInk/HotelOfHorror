...
- Narrative messages generated by the most recently resolved action are displayed at full black, while messages from earlier actions are faded so the newest result is immediately identifiable.
...
- Ordinary weapon caches contain forks, clubs, wooden stakes, or knives.
- Across the 10 ordinary caches there are exactly 3 forks, 3 clubs, 2 wooden stakes, and 2 knives, assigned randomly among the levels.
...
- A successful fork hit inflicts 1 to 2 damage.
